document.addEventListener('DOMContentLoaded', () => {
    ...
    //make the tetronmino move down every second
    ...
    //  move the tetromino right, unless ia at the edge or there is a blockage
    function moveRight() {
        undraw()
    ...
    //showup up-next tetromino in mini-grid display
